...
if (mysqli_num_rows($resultUser) > 0){
    ...
    $panelnum = htmlspecialchars($infoUser[0]['panelnum']);
...
if (isset($_POST['submit'])) {
    ...
    if(!$pass_err){
        ...
        $sql = "UPDATE panel SET pass = '$hashed_password', salt = '$salt' WHERE panelid = '$panelid'";
...
<head>
    ...
    <style>
        ...
        .sticky-textbox-2{
            right: 0;
            width: calc(100% - 40px - 208px); /* Adjust as needed */
        ...
        <div class="main">
            ...
            <form class="profile-form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                ...
                <div class="row g-3 align-items-center py-2">
                    <div class="col-auto">
                        <label for="panelnum" class="col-form-label">Panel Number :</label>
                    </div>
                    <div class="col">
                        <input type="text" class="form-control sticky-textbox-2" disabled readonly id="panelnum" placeholder="Info not completed, please inform IDP committee" value="<?php echo isset($panelnum)?htmlspecialchars($panelnum):'';?>">
                    </div>
                </div>
                <div class="row g-3 align-items-center py-2">
                    <div class="col-auto">
                ...
                <div class="row g-3 align-items-center py-2">
                    ...
                    <div class="col form-floating sticky-textbox-4 ">
                        <input type="password" class="form-control custom-textbox" id="oldpass" name="oldpass" placeholder="Enter old Password" value="<?php echo isset($_POST['oldpass'])? htmlspecialchars($_POST['oldpass']):'';?>">
                        <label for="oldpass" class="ms-3 font-size-custom-label"><span class="custom-display">Enter Your</span> Old Password</label>
                    </div>
                </div>
                <div class="row g-3 align-items-center py-2">
                    <div class="col form-floating sticky-textbox-5 ">
                        <input type="password" class="form-control custom-textbox" id="newpass" name="newpass" placeholder="Enter new Password" value="<?php echo isset($_POST['newpass'])? htmlspecialchars($_POST['newpass']):'';?>">
                        <label for="newpass" class="ms-3 font-size-custom-label">New Password</label>
                    </div>
                </div>
                <div class="row g-3 align-items-center py-2">
                    <div class="col form-floating sticky-textbox-5">
                        <input type="password" class="form-control custom-textbox" id="confirmpass" name="confirmpass" placeholder="Enter again the Password" value="<?php echo isset($_POST['confirmpass'])?htmlspecialchars($_POST['confirmpass']):'';?>">
                        <label for="confirmpass" class="ms-3 font-size-custom-label">Confirm Password</label>
                    </div>
                </div>
