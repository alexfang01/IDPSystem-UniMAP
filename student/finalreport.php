...
<head>
    ...
    @media(max-width: 768px){
        ...
        <div class="main">
            ...
            <div class="container">
            <form class="report-form" action="upload.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center py-2 mt-4">
                    <div class="col-auto">
                        <label for="report" class="col-form-label"><span class="custom-display">Please </span>upload <span class="custom-display">your final </span>report (PDF):</label>
                    </div>
                    <div class="col">
