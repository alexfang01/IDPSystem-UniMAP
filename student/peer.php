...
<head>
    ...
    @media (max-width: 768px){
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                                        ...
                                        <?php foreach ($members as $member): ?>
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT timeSubmit FROM peerstudent WHERE grader = '$studentid' AND member = '$memberid'";
                ...
                <div class="container mt-5">
                    <a id="download-pdf" class="btn btn-primary btn-custom-shadow" href="../fileuploaded/rubrics/rubric_peerstudent.pdf" download="rubric_peerstudent.pdf" style="background-color: #4CE833; border: none; color: black;"><i class="fa-solid fa-file-arrow-down pe-1"></i><span class="custom-display">Download</span> Rubrics</a>
                </div>
                <div class="container">
   ...
   <script>
        ...
        const url = '../fileuploaded/rubrics/rubric_peerstudent.pdf';
