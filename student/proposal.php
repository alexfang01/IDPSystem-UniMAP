...
<head>
    ...
    @media(max-width: 768px){
        ...
        <div class="main">
            ...
            <div class="container">
                <form class="proposal-form" action="upload.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 align-items-center py-2 mt-4">
                        <div class="col-auto">
                            <label for="proposal" class="col-form-label"><span class="custom-display">Please </span>upload <span class="custom-display">your project </span>proposal (PDF):</label>
                        </div>
                        <div class="col">
