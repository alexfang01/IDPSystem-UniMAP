<?php
    ...
    if (isset($_POST['approve'])) {
        ...
        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Project Video & Poster Approved, Student no longer able to edit');</script>";
        } else {
            echo 'Query error: ' . mysqli_error($conn);
        }
        //file information to ensure it fill the textbox
    ...
    if (isset($_POST['reject'])) {
        ...
        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Project Video & Poster Rejected, Student able to make changes');</script>";
        } else {
            echo 'Query error: ' . mysqli_error($conn);
        }
        //file information to ensure it fill the textbox
        ...
        <div class="main">
            ...
            <div class="vidposter-form">
                ...
                <div class="row g-3 align-items-center py-2 mt-4">
                    <div class="col-auto">
                        <label for="vidlink" class="col-form-label">Video link :</label>
                    </div>
                    <div class="col">
                        <?php if (isset($infovidlink[0]['videolink']) && !empty($infovidlink[0]['videolink'])): ?>
                            <a href="<?php echo htmlspecialchars($infovidlink[0]['videolink']); ?>" target="_blank" class="form-control sticky-textbox-1" style="display: block; padding: 0.375rem 0.75rem; height: auto; line-height: 1.5; background-color: #e9ecef; border: 1px solid #ced4da; border-radius: 0.25rem;">
                                <?php echo htmlspecialchars($infovidlink[0]['videolink']); ?>
                            </a>
                        <?php else: ?>
                            <span class="form-control sticky-textbox-1" style="display: block; padding: 0.375rem 0.75rem; height: auto; line-height: 1.5; background-color: #e9ecef; border: 1px solid #ced4da; border-radius: 0.25rem;">
                                No Video Link Yet
                            </span>
                        <?php endif; ?>
                    </div>
            ...
            <div class="container">
                <form class="vidposter-form" action="vidposter.php" method="post">
