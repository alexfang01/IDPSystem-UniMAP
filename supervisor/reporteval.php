...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM reporteval WHERE grpid='$grpid' AND svid='$svid'";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0){
...
if(isset($_POST['submit'])){
    ...
    $trait1mark = $trait1 * 0.15;
    $trait2mark = $trait2 * 0.15;
    $trait3mark = $trait3 * 0.20;
    ...
    $finalMarkTemp = ($totalMark / 5)*20;
    $finalMark = mysqli_real_escape_string($conn, $finalMarkTemp);
    
    // check whether Supervisor is examiner or Supervisor for this group
    $flag_ownsv = 0;
    $sql = "SELECT * FROM supervisor WHERE grpid='$grpid' AND svid='$svid'";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0){
        $flag_ownsv = 1; // yes, it's marking own group
    }
    ...
    // if exist, update
    if (mysqli_num_rows($result) > 0){
        $sql = "UPDATE reporteval SET trait1='$trait1', trait2='$trait2', trait3='$trait3', trait4='$trait4', trait5='$trait5', trait6='$trait6', trait7='$trait7', trait8='$trait8', comment='$comment', submitTime='$submitTime'";
        if (mysqli_query($conn, $sql)) {
            if($flag_ownsv){
                $sql = "UPDATE grpmark SET reportMarkSV='$finalMark' WHERE grpid = '$grpid'";
                if (mysqli_query($conn, $sql)) {
                    echo "<script>alert('Update successfully');</script>";
                    echo "<script>window.location.href = 'reportevalHome.php';</script>";
                }else {
                    echo 'query error'.mysqli_error($conn);
                }
            }else{
                $sql = "UPDATE grpmark SET reportMarkExaminer='$finalMark' WHERE grpid = '$grpid'";
                if (mysqli_query($conn, $sql)) {
                    echo "<script>alert('Update successfully');</script>";
                    echo "<script>window.location.href = 'reportevalHome.php';</script>";
                }else {
        ...
        $sql = "INSERT INTO reporteval (svid, grpid, trait1, trait2, trait3, trait4, trait5, trait6, trait7, trait8, comment, submitTime) VALUES ('$svid', '$grpid', '$trait1', '$trait2', '$trait3', '$trait4', '$trait5', '$trait6', '$trait7', '$trait8', '$comment', '$submitTime')";
        if (mysqli_query($conn, $sql)) {
            if($flag_ownsv){
                ...
                if (mysqli_num_rows($result) > 0){
                    ...
                    $sql = "INSERT INTO grpmark (grpid, reportMarkSV) VALUES ('$grpid', '$finalMark')";
                    if (mysqli_query($conn, $sql)) {
                        echo "<script>alert('Successfully evaluate');</script>";
                        echo "<script>window.location.href = 'reportevalHome.php';</script>";
                    }else {
                ...
                if (mysqli_num_rows($result) > 0){
                    ...
                    $sql = "INSERT INTO grpmark (grpid, reportMarkExaminer) VALUES ('$grpid', '$finalMark')";
                    if (mysqli_query($conn, $sql)) {
                        echo "<script>alert('Successfully evaluate');</script>";
                        echo "<script>window.location.href = 'reportevalHome.php';</script>";
                    }else {
            ...
            <form class="profile-form" method="post" action="">
                ...
                <div class="row g-3 align-items-center py-2">
                    ...
                    <h5 class="text-center py-3">
                            ...
                            <strong>You are now evaluating Group <?php echo isset($infoGrp[0]['grpnum'])?htmlspecialchars($infoGrp[0]['grpnum']):''; ?>
                            </strong>   
                ...
                <div class="row g-3 align-items-center py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>1. Introduction & Survey Analysis [CO1/PO3] (15%)</strong>
                        </div>
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>2. Methodology [CO1/PO3] (15%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-center py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>3. Results & Discussion [CO2/PO6] (20%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>4. Health and Safety, Cultural and Benefit To Society [CO2/PO6] (10%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>5. Environment and Sustainability [CO3/PO7] (10%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>6. Project Commercialization Potential [CO7/PO11] (10%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>7. Conclusion & Future Work [CO1/PO3] (10%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <div class="row g-3 align-items-left py-2">
                    <div class="text-justify mb-3">
                        <div>
                        <strong>8. Professionalism and Ethical Responsibilities in Report Writing [CO4/PO8] (10%)</strong>
                        </div>
                        <div class="form-check form-check-inline">
