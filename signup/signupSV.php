...
if (isset($_POST['svSignup'])) {
    ...
    if (!$name_err && !$staffNum_err && !$email_err && !$pass_err && !$cpass_err) {
        ...
        $sql = "INSERT INTO supervisor(name, staffnum, email, pass, verify, salt) VALUES ('$name', '$staffNum', '$email', '$hashed_password', 0, '$salt')";
...
<body class="login-pic fade-in">
    ...
    <div class="row">
        ...
        <div class="box">
            ...
            <!-- Supervisor Form -->
          <form method="post" action="signupSV.php" id ="svSignupForm">
          <!-- Supervisor signup content -->
          <div id="svContent">
            ...
            <button type="submit" id="svSignup" name="svSignup" class="btn btn-success btn-block login-btn btn-custom-shadow custom-btn-signup">REGISTER</button>
          </div>
          </form>
  ...
  <script>
    ...
    role2.checked = true; // let it stay checked
