        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="container">
                    ...
                    <h5 class="text-justify text-center mt-3">Take note on <strong>Important Events</strong><button style="margin:10px;" class="btn btn-primary" type="button" onclick="window.location.href='./addEvent.php'">Add New Event</button></h5>
                    <?php $weekTemp = -1; ?>
