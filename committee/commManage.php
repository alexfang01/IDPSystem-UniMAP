...
<body>
    ...
    if ($cpass == '1') {
        ...
        ';
        echo "<form action=\"commManage.php\" method=\"POST\">
        ...
        echo "</select>
        <form method=\"post\" action=\"commManage.php\">
        ...
        <form class=\"text-center\" method=\"GET\" action=\"commManage.php\">
    ...
    function printSupervisor($paginated_data)
    {
        foreach ($paginated_data as $row) {
            ...
            if ($edit == 1 && $editid == $svid) {
                echo "<tr>";
                echo "<td>$svid</td>";
                echo "<form id=\"myForm\" method=\"post\" action=\"commManageFunc.php\">";
    ...
    function veriButton($verify, $id)
    {
        if ($verify == '1') {
            echo "<div class=\"row justify-content-center\">
                    <div class=\"col-auto\">
                        <form id=\"myForm\" method=\"post\" action=\"commManageFunc.php\">
